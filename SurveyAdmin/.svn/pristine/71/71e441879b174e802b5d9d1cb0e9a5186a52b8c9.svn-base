...
using SurveyAdmin.Providers;
using SurveyAdmin.Results;
...
namespace SurveyAdmin.Controllers.api
{
    ...
    public class AccountController : ApiController
    {
        ...
        public UserInfoViewModel GetUserInfo()
        {
            ...
            var applicationUser = db.Users.Find(User.Identity.GetUserId<int>());
        ...
        private class ExternalLoginData
        {
            ...
            public IList<Claim> GetClaims()
            {
                ...
                {
                    claims.Add(new Claim(ClaimTypes.Locality, Organization, null, LoginProvider));
                }
...
//                if ()
            ...
            public static ExternalLoginData FromIdentity(ClaimsIdentity identity)
            {
                ...
                return new ExternalLoginData
                {
                    ...
                    Organization = identity.FindFirstValue(ClaimTypes.Locality)
                };
            }
        }
