...
namespace SurveyAdmin.Controllers
{
    ...
    public partial class AccountController : Controller
    {
        ...
        public AccountController()
            : this(new UserManager<ApplicationUser, int>(
                new UserStore<ApplicationUser, Role, int, AppUserLogin, AppUserRole, AppUserClaim>(
        ...
        public virtual ActionResult Register()
        {
            ...
            types.Add(new SelectListItem {Text = "CTA", Value = "1"});
            types.Add(new SelectListItem {Text = "CTA Service Point", Value = "2", Selected = true});

            ViewBag.AccountType = types;
            return View();
        }
