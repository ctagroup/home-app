...
public class ChatActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle.getString("name") != null) {
            ...
            textview.setTextColor(Color.parseColor("#22215D"));
        ...
        send_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TextView textview = new TextView(getApplicationContext());
                textview.setTextSize(20);
                textview.setTextColor(Color.parseColor("#60AA4C"));
    ...
    protected void onDestroy() {
        super.onDestroy();
        SharedPreferences.Editor edit = prefs.edit();
        edit.putString("CURRENT_ACTIVE", null);
        edit.commit();
    }
    ...
    private class Send extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            JSONObject jObj = json.getJSONFromUrl(getResources().getString(R.string.chat_server)+ "/send", params);
            return jObj;
