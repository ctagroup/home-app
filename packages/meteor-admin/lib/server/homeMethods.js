...
Meteor.methods(
	{
		...
		addClient: function(first_name,middle_name,last_name,suffix,ssn,dob,race,ethnicity,gender,veteranStatus,disablingConditions,residencePrior,entryDate,exitDate,destination,householdId,relationship,loc,shelter){
			var clientInfoCollection = adminCollectionObject("clientInfo");
			var clientRecords = clientInfoCollection.insert({firstName:first_name,middleName:middle_name,lastName:last_name,suffix:suffix,ssn:ssn,dob:dob,race:race,ethnicity:ethnicity,gender:gender,veteranStatus:veteranStatus,disablingConditions:disablingConditions,residencePrior:residencePrior,entryDate:entryDate,exitDate:exitDate,destination:destination,householdId:householdId,relationship:relationship,location:loc,shelter:shelter});
			return clientRecords;
		},
		updateClient: function(clientInfoID,first_name,middle_name,last_name,suffix,ssn,dob,race,ethnicity,gender,veteranStatus,disablingConditions,residencePrior,entryDate,exitDate,destination,householdId,relationship,loc,shelter){
			var clientInfoCollection = adminCollectionObject("clientInfo");
			clientInfoCollection.update(clientInfoID, {$set: {firstName:first_name,middleName:middle_name,lastName:last_name,suffix:suffix,ssn:ssn,dob:dob,race:race,ethnicity:ethnicity,gender:gender,veteranStatus:veteranStatus,disablingConditions:disablingConditions,residencePrior:residencePrior,entryDate:entryDate,exitDate:exitDate,destination:destination,householdId:householdId,relationship:relationship,location:loc,shelter:shelter}});
		},
