  ...
  collections: {
    ...
    eligibleClients: {
      ...
      tableColumns: [
        {
          title: 'Client ID',
          data: 'clientId', // note: access nested data like this
          render(value) {
        ...
        {
          title: 'Score',
          data: 'surveyScore', // note: access nested data like this
        },
        {
          title: 'Survey Date',
          data: 'surveyDate', // note: access nested data like this
        },
        {
          title: 'Match Status',
          data: 'matched', // note: access nested data like this
        },
      ],
      templates: {
        view: {
    ...
    housingMatch: {
      ...
      tableColumns: [
        ...
        {
          title: 'Match Date',
          data: 'matchDate', // note: access nested data like this
        },
        {
          title: 'User ID',
