...
import { EligibleClientsCache, GlobalHouseholdsCache, HousingMatchCache,
  HousingUnitsCache, ProjectsCache } from '/imports/both/cached-subscriptions';
  ...
  documentEditButton(path) {
    return {
      ...
      createdCell(node, cellData/* , rowData */) {
        $(node).html(Blaze.toHTMLWithData(Template.AppEditBtn, { path, _id: cellData }));
      },
      width: '45px',
      orderable: false,
    };
    ...
    housingMatch: {
      ...
      templates: {
        view: {
          ...
          waitOn() {
            return HousingMatchCache.subscribe('housingMatch');
          },
        },
      },
    },
    ...
    globalHouseholds: {
      ...
      templates: {
        view: {
          ...
          waitOn() {
            return GlobalHouseholdsCache.subscribe('globalHouseholds');
          },
        },
        edit: {
