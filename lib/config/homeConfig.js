        ...
        },
        {
          ...
          render(value, type, doc) {
            ...
            return `<button
              ...
              data-client-id="${doc.eligibleClients.clientId}">Notify</button>`;
          },
        },
      ],
      templates: {
    ...
    responses: {
      ...
      tableColumns: [
        ...
        },
        {
          ...
          label: 'Client',
          render(value) {
            const response = responses.findOne({ _id: value });
        ...
        },
        {
          ...
          render(value, type, doc) {
            let val = '';
            const responseDetails = responses.findOne({ _id: doc._id });
            ...
            switch (value) {
              case 'Completed':
                if (subId) {
                  ...
                  val = `<a href="#" id="${doc._id}" class="btn UploadResponses">Upload to HMIS</a>`;
                }
                break;
              case 'Paused':
      ...
      templates: {
        view: {
          ...
          data() {
            return {
              admin_table: AdminTables.responses,
            };
          },
        },
        new: {
          ...
          data() {
            ...
            if (client && this.params.query && this.params.query.isHMISClient
                && this.params.query.schema) {
